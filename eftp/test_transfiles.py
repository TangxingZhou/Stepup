...
class Testmkdir(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.mtransfer=TransFile('.','/home/tangxinz/eftp','135.251.238.34','tangxinz','zhou19891001',['asd.txt','zxc.txt'])
    ...
    def test_mkdir_local_case1(self):
        ...
        self.assertTrue(os.path.isdir(path), msg='Make "'+path+'" at local failed!')
    ...
    def test_mkdir_remote_case1(self):
        ...
        print(result)
        self.assertIn(path,result,msg='Make "'+path+'" at remote failed!')
...
class Testisfile(unittest.TestCase):
    ...
    def test_isfile_local_case1(self):
        tocheck='mydir'
        self.assertFalse(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'UP'),msg=tocheck+'does not exist')
    ...
    def test_isfile_local_case5(self):
        tocheck='testdir'
        self.assertFalse(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'UP'),msg=tocheck+'is not file')

    def test_isfile_local_case6(self):
        tocheck='test.txt'
        self.assertTrue(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'UP'),msg=tocheck+'is not file')
    ...
    def test_isfile_remote_case1(self):
        tocheck='mydir'
        self.assertFalse(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'DOWN'),msg=tocheck+'does not exist')
    ...
    def test_isfile_remote_case5(self):
        tocheck='testdir'
        self.assertFalse(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'DOWN'),msg=tocheck+'is not file')

    def test_isfile_remote_case6(self):
        tocheck='test.txt'
        self.assertTrue(self.mtransfer.isfile(self.mtransfer.mftp,tocheck,'DOWN'),msg=tocheck+'is not file')
